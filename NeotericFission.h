#ifndef _NEOTERIC_FISSION_H_
#define _NEOTERIC_FISSION_H_
...
namespace NeotericFission {
  ...
  enum {
    ...
    Iron, Emerald, Copper, Tin, Magnesium, Slime,
    Netherite, Prismarine, Obsidian, Purpur, Fluorite,
    Aluminum, Nether_Brick, Lithium, Arsenic, End_stone,
    Manganese, Lead, Boron, Silver, Nitrogen, Active,
    // Other
